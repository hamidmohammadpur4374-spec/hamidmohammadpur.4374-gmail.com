const C='modland-admin-v15';
const A=['./admin-v2.html','./admin-pro-v1.css?v=5','./admin-platform-v2.css?v=4','./admin-pro-core.js?v=4','./admin-pro-products.js?v=4','./admin-pro-admin.js?v=4','./admin-vnext.js?v=4','./admin-pro-v2.js?v=4','./admin-ui-v3.js?v=4','./admin-catalog-only-v1.js?v=4','./manifest.webmanifest','./icon.svg','./apple-touch-icon.png'];
