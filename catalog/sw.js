const C='modland-customer-v12',IMG='modland-customer-images-v1',MAX_IMAGES=100;
const S=['./','./index.html','./product.html','./catalog-pro-v6.css?v=12','./catalog-vnext.css?v=12','./catalog-platform-v2.css?v=12','./catalog-pro-v8.js?v=12','./product-pro-v6.css?v=12','./product-pro-v7.js?v=12','./manifest.webmanifest','../icon.svg','../apple-touch-icon.png'];
